...
const LogIn = ({ onClose }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const { accessToken, role, memberId } = response.data; // memberId 추가
      login(accessToken, role, memberId); // AuthContext의 login 메서드 호출에 memberId 추가
        ...
        <>
          <Modal onClose={onClose}>
            ...
            <Form
              ...
              findAccount={
                <p>
                  <span onClick={handleFindEmail} style={{ cursor: 'pointer' }}>
                    아이디 찾기
                  </span>
                  /{' '}
                  <span
